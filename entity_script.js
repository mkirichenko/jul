...
function displayEntityDetails(entityId, data) {
  ...
  const previousTestRunsList = document.getElementById(
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (entityId) {
    ...
    document.getElementById("previous-test-runs-list").innerHTML =
      "<li>No entity ID provided in the URL.</li>";
    document.getElementById("current-test-status").textContent =
      "Cannot display status without entity ID.";
